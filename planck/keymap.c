...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = {
    ...
    {KC_GRV,  KC_LCTL, KC_LALT, KC_LGUI, MO(_RAISE), KC_SPC,  KC_SPC,  KC_MINS, KC_EQL,  KC_BSLS, KC_SLSH, KC_ENT}
  },
  [_RAISE] = {
    {KC_F12,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______},
