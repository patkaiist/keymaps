...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_ADJ] = {
		...
		{KC_PSCR,	_______,	KC_VOLD,	_______,	_______,	_______,	KC_LEFT,	KC_UP,		KC_DOWN,	KC_RGHT,	_______,	_______},
		{_______,	_______,	_______,	KC_PSCR,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______},
		{BL_0,		BL_1,		BL_2,		BL_3,		KC_TRNS,	_______,	_______,	_______,	_______,	_______,	_______,	_______}
	}
};
